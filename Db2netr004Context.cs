...
public partial class Db2netr004Context : DbContext
{
    public Db2netr004Context()
    {
    }

    public Db2netr004Context(DbContextOptions<Db2netr004Context> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.SystemInformationId).HasName("PK__BuildVer__35E58ECAA924663B");
